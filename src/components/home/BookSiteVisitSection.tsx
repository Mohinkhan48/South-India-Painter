...
export default function BookSiteVisitSection() {
  ...
  const inputClass = (field: string) =>
    `w-full h-[56px] px-4 bg-white border rounded-[14px] text-[15px] text-[#1a1a1a] placeholder-[#9CA3AF] transition-all focus:outline-none focus:ring-2 focus:ring-[#F26A4B]/20 focus:border-[#F26A4B] ${
  ...
  return (
    <section className="w-full flex justify-center bg-[#FAF8F5] px-4 md:px-8 mt-[120px] mb-[120px]">
      <m.div
        ...
        className="w-full max-w-[1280px] rounded-[32px] overflow-hidden shadow-[0_32px_80px_rgba(22,50,79,0.12)] flex flex-col lg:flex-row"
        style={{ minHeight: 700 }}
      >
        ...
        <div className="relative lg:w-[50%] min-h-[340px] lg:min-h-0 flex-shrink-0">
          ...
          {/* Overlay text */}
          <div className="relative z-10 flex flex-col justify-center h-full px-10 md:px-14 py-16">
            <m.div
            ...
            >
              <h2 className="text-white font-black text-[52px] md:text-[64px] leading-[1.05] uppercase tracking-tight mb-6">
                Unlock<br />
                Better<br />
                Spaces<br />
                With A<br />
                <span className="text-white">Free Site</span><br />
                <span className="text-white">Visit</span>
              </h2>
              {/* Orange underline accent */}
              <div className="w-[72px] h-[5px] bg-[#F26A4B] rounded-full" />
            </m.div>
          </div>
        </div>
        ...
        <m.div
          ...
          className="lg:w-[50%] bg-white flex flex-col justify-center px-10 md:px-[60px] py-12 md:py-16"
        >
          {/* Orange label */}
          <p className="text-[#F26A4B] font-semibold text-[12px] tracking-[0.18em] uppercase mb-4">
            Free Consultation
          </p>
          ...
          <p className="text-[#6B7280] text-[15px] mb-8 leading-[1.6]">
            ...
            <span className="text-[#F26A4B] font-medium cursor-pointer hover:underline">from our team.</span>
          </p>
          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-[22px]">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <div className="flex items-center justify-center h-[56px] px-4 rounded-[14px] border border-[#E5E7EB] bg-white text-[15px] font-medium text-[#374151] shrink-0">
                  +91
                </div>
                <input
                    ...
                    >
                      <div
                        ...
                        className={`w-5 h-5 rounded-full border-2 shrink-0 flex items-center justify-center transition-all duration-200 ${
                          active
                            ? 'border-[#F26A4B] bg-[#F26A4B]'
                            : 'border-[#D1D5DB] bg-white group-hover:border-[#F26A4B]/60'
                        }`}
                      >
                      ...
                      <span
                        ...
                        className={`text-[14px] transition-colors ${
                          active ? 'text-[#F26A4B] font-medium' : 'text-[#4B5563]'
                        }`}
                      >
                        {service}
                      </span>
            ...
            <p className="text-[12px] text-[#9CA3AF] leading-[1.6] -mt-1">
              ...
              <span className="text-[#F26A4B] cursor-pointer hover:underline">Terms & Conditions.</span>
            </p>
            ...
            <m.button
              type="submit"
              disabled={submitted}
              whileHover={shouldReduceMotion ? undefined : { y: -2, boxShadow: '0 20px 40px rgba(242,106,75,0.38)' }}
