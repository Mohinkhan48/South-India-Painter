          ...
          <div className="flex justify-center lg:justify-end">
            <AnimatePresence>
              <m.div
                ...
                className="group w-full max-w-[390px] rounded-[24px] border border-white/15 bg-[rgba(16,42,67,0.62)] p-4 shadow-[0_20px_55px_rgba(8,31,51,0.24)] backdrop-blur-xl transition-all duration-250 hover:-translate-y-1 hover:border-white/20 hover:shadow-[0_24px_65px_rgba(8,31,51,0.32)]"
              >
                <div className="flex min-h-[72px] items-center gap-4 rounded-[20px] bg-[rgba(255,255,255,0.08)] px-4 py-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--color-accent)] text-white shadow-[0_10px_20px_rgba(231,104,75,0.22)]">
                    <Star className="h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-[26px] font-bold text-white">{business.heroStats[0].value}</p>
                ...
                <div className="flex min-h-[72px] items-center gap-4 rounded-[20px] bg-[rgba(255,255,255,0.05)] px-4 py-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[rgba(16,42,67,0.9)] text-white shadow-[0_10px_20px_rgba(0,0,0,0.16)]">
                    <ShieldCheck className="h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-[26px] font-bold text-white">{business.heroStats[1].value}</p>
                    <p className="mt-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/70">
